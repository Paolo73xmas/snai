...
async def query_user_profiless(
    ...
    """Query user_profiless with filtering, sorting, and pagination"""
...
async def get_user_profiles(
    ...
    """Get a single user_profiles by ID"""
...
async def update_user_profiless_batch(
    ...
    """Update multiple user_profiless in a single request"""
...
async def update_user_profiles(
    ...
    """Update an existing user_profiles"""
...
async def delete_user_profiless_batch(
    ...
    """Delete multiple user_profiless by their IDs"""
...
async def delete_user_profiles(
    ...
    """Delete a single user_profiles by ID"""
